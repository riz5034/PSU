...
exports.inhandler = (event, context, callback) => {
    ...
    switch (event.httpMethod) {
        ...
        case 'GET':
            ...
            if(event.queryStringParameters.Type == 'getItem'){
                dynamo.getItem({TableName:event.queryStringParameters.TableName,Key:{Material_ID:event.queryStringParameters.id}},done)
            }
            else{
